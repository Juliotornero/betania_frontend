...
const ModalFormularioRegistros = () => {
    ...
    const handleSubmit = async e => {
       ...
       await submitRegistro({id, documento, nombre, apellido, correo, celular, fechaEntrada, fechaSalida, metodoPago, precioTotal, habitacion: params.id, deuda, estado, nota })
