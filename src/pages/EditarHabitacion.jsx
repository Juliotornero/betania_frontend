...
const EditarHabitacion = () => {
    ...
    const { obtenerHabitacion, habitacion, cargando, handleModalRegistro, eliminarHabitacion } = useHabitacion();
    ...
    const handleClick = () => {
        if (confirm('Deseas eliminar la habitacion?')) {
    ...
    return (
        <>
            <div className="flex justify-between px-10 uppercase font-bold">
                <div>Editando habitacion nro: {habitacion.numero}</div>
